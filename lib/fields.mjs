...
const COMPOSITIONS = {
  ...
  // edge-hugging fields for slides: dense against one edge, dissolving into the page
  "edge-right": [[1.02, 0.5, 0.36], [1.0, 0.12, 0.2], [1.0, 0.88, 0.22]],
  "edge-left": [[-0.02, 0.5, 0.36], [0.0, 0.14, 0.2], [0.0, 0.86, 0.22]],
  corner: [[1.0, 0.0, 0.4], [0.82, 0.08, 0.16]],
};
